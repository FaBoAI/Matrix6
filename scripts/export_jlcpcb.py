...
assert hashlib.sha256(CAD.read_bytes()).hexdigest() == 'd4baae69416e07bda5e7b92d2c81b41b77b089a59c8f3010dbfb94d57be7886e', 'This exporter is specific to the reviewed v0.5 PCB.'
...
text(60, 65, 'MATRIX6 v0.5 — PCB FABRICATION / IMPEDANCE REQUIREMENTS', 37)
text(60, 108, 'Prototype quotation • CAD d1438c6 • All dimensions in mm • 2026-09-07', 23)
...
('130 × 0.300 vias; 40 × 1.000 connector holes;',24),
('4 plated USB slots (0.600 tool diameter).',24),
('NPTH: 2 × 0.650 USB positioning holes.',24),
('Epoxy-fill and copper-cap U1 thermal holes.',24),
